...
import org.openqa.selenium.WebElement;
  ...
  public class ACA_Optimize_Module_Path 
  {
	...
	By SelectOnSpend = By.xpath("(//input[@class='ht-21' and @style='border: 0px; width: 100%; padding-right: 7px; text-align: right;'])[1]"); ///html/body/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div[3]/div/div/div/div/input");
	...
	By Opt_Spend_0_SelectOnSpend = By.xpath("(//input[@class='ht-21' and @style='border: 0px; width: 100%; padding-right: 7px; text-align: right;'])[1]"); ///html/body/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div[3]/div/div/div/div/input");
    ...
    By Change_Optimization_Goal = By.xpath("//div[@class='dd-text fs-11'][text()='Maximize Revenue By Target Budget']"); ////*[@id='main']/div/div/div/div/div/div/div/div/div/div/div/div/div/button");
    By Optimization_Goal_Change_Value = By.xpath("(//button[@class='dd-item fs-11 dropdown-item'])[position()=3]"); ///html/body/div/div/div/div/div/div/div/div/div/div/div/div[3]/div/div/div/button");
    ...
    By Min_Value_Change = By.xpath("(//div[contains(@class, 'pd-r-10')]/input[@type='number' and @class='sm-input-rt' and @placeholder='25' and @value='25'])[1]"); ///html/body/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div[2]/input");
    By Max_Value_Change = By.xpath("(//div[contains(@class, 'pd-r-10')]/input[@type='number' and @class='sm-input-rt' and @placeholder='25' and @value='25'])[2]"); ///html/body/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div[4]/input");
